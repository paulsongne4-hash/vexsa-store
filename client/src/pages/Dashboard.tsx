...
import { ArrowDownToLine, BarChart3, CheckCircle2, CloudUpload, Eye, FileImage, FileUp, Github, Globe2, ImagePlus, Loader2, LogOut, PackagePlus, Plus, ShieldCheck, Sparkles, TrendingUp, UserRound, X } from "lucide-react";
...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    const channel = client.channel(`dashboard-${user.id}`).on("postgres_changes", { event: "UPDATE", schema: "public", table: "apps", filter: `owner_id=eq.${user.id}` }, () => void loadDashboard()).subscribe();
