...
import { ArrowDownToLine, BarChart3, CheckCircle2, CloudUpload, Eye, FileImage, FileUp, Github, Globe2, ImagePlus, Loader2, LogOut, PackagePlus, Plus, RefreshCw, ShieldCheck, Sparkles, MessageCircle, Trash2, TrendingUp, UserRound, X } from "lucide-react";
...
export default function Dashboard() {
  ...
  const [form, setForm] = useState({ name: "", description: "", category: "Productivité", version: "1.0.0", downloadUrl: "", supportContact: "" });
  ...
  const handlePublish = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setForm({ name: "", description: "", category: "Productivité", version: "1.0.0", downloadUrl: "", supportContact: "" });
